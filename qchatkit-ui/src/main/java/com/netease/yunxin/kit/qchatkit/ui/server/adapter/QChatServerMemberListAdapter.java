...
public class QChatServerMemberListAdapter extends CommonMoreAdapter<QChatServerRoleMemberInfo, QChatRoleMemberViewHolderBinding> {
    ...
    @NonNull
    @Override
    public BaseMoreViewHolder<QChatServerRoleMemberInfo, QChatRoleMemberViewHolderBinding> getViewHolder(@NonNull ViewGroup parent, int viewType) {
        QChatRoleMemberViewHolderBinding binding = QChatRoleMemberViewHolderBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
