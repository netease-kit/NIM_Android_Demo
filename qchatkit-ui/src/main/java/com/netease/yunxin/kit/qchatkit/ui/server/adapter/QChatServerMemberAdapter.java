...
public class QChatServerMemberAdapter extends QChatCommonAdapter<QChatServerMemberWithRoleInfo, QChatServerMbemberInfoWithRoleItemBinding> {
    public QChatServerMemberAdapter(Context context, Class<QChatServerMbemberInfoWithRoleItemBinding> viewBinding) {
        super(context, viewBinding);
    }

    @Override
    public void onBindViewHolder(@NonNull ItemViewHolder<QChatServerMbemberInfoWithRoleItemBinding> holder, int position, QChatServerMemberWithRoleInfo data) {
        ...
        binding.cavIcon.setData(data.getAvatarUrl(), nickname, ColorUtils.avatarColor(data.getAccId()));
    }
}
