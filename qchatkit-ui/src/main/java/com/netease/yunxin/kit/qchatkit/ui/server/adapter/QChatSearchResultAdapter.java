...
public class QChatSearchResultAdapter extends QChatCommonAdapter<QChatSearchResultInfo, QChatServerSearchResultItemBinding> {
    ...
    @Override
    public void onBindViewHolder(QChatServerSearchResultItemBinding binding, int position, QChatSearchResultInfo data, int bingingAdapterPosition) {
        ...
        tvActionAndTip.setOnClickListener(v -> QChatServerRepo.applyServerJoin(data.serverInfo.getServerId(),
                new FetchCallback<Void>() {
                    ...
                    public void onSuccess(@Nullable Void param) {
                        ...
                        Toast.makeText(context,context.getString(R.string.qchat_server_had_appled_tip),Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onException(@Nullable Throwable exception) {
                        Toast.makeText(v.getContext(), "exception " + exception, Toast.LENGTH_SHORT).show();
                    }
                }));
    }
}
