...
final class BitmapUtils {
    ...
    static RotateBitmapResult rotateBitmapByExif(Bitmap bitmap, Context context, Uri uri) {
        ...
        try {
            ...
            ALog.e("BitmapUtils", "rotateBitmapByExif", exception);
        }
    ...
    static Uri writeTempStateStoreBitmap(Context context, Bitmap bitmap, Uri uri) {
        try {
            ...
            ALog.w("AIC", "Failed to write bitmap to temp file for image-cropper save instance state", e);
            return null;
        }
    }
    ...
    static Bitmap resizeBitmap(
        ...
        try {
            ...
            ALog.w("AIC", "Failed to resize cropped image, return bitmap before resize", e);
        }
        return bitmap;
    }
