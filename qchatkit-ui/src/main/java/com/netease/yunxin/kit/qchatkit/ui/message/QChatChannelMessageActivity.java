 ...
 * include Message Page and Member list
 */
public class QChatChannelMessageActivity extends CommonActivity {
    ...
    protected void initViewModel() {
        ...
        viewModel.getChannelLiveData().observe(this, result -> {
        ...
        viewModel.getChannelInfoLiveData().observe(this, result -> {
        ...
        viewModel.getMemberRoleLiveData().observe(this, result -> {
            if (result.getLoadStatus() == LoadStatus.Success) {
    ...
    protected void initView() {
        ...
        viewBinding.qChatMessageTitleActionIv.setOnClickListener(view -> {
            viewBinding.qChatChannelMessageDrawerLayout.openDrawer(GravityCompat.END);
        });

        viewBinding.qChatMessageMemberTitleSetting.setOnClickListener(view -> {
        ...
        viewBinding.qChatMessageTitleLeftIv.setOnClickListener(view -> {
        ...
        recyclerViewAdapter.setViewHolderFactory((parent, viewType) -> {
            if (viewType == QChatViewType.CHANNEL_MEMBER_VIEW_TYPE) {
                QChatChannelMemberStatusViewHolderBinding viewHolderBinding = QChatChannelMemberStatusViewHolderBinding.inflate(getLayoutInflater(), parent, false);
        ...
        viewBinding.qChatMessageMemberRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
        ...
        getSupportFragmentManager().beginTransaction().add(viewBinding.qChatMessageBodyLayout.getId(), messageFragment).commit();
    }
    ...
    public static void launch(Activity activity, long serverId, long channelId, String channelName, String channelTopic) {
