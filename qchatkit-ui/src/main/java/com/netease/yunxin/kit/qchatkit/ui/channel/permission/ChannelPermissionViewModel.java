...
/**
 * channel permission setting view model
 * modify member and role permission
 */
public class ChannelPermissionViewModel extends BaseViewModel {
    ...
    private void fetchRoleData(long serverId, long channelId, long offset) {
        ALog.d(TAG, "fetchRoleData", "serverId:" + serverId + "channelId:" + channelId);
        QChatChannelRepo.fetchChannelRoles(serverId, channelId, offset, rolePageLimit, new FetchCallback<List<QChatChannelRoleInfo>>() {
            @Override
            public void onSuccess(@Nullable List<QChatChannelRoleInfo> param) {
                ...
                if (param != null && param.size() > 0) {
                    ...
                    for (int index = 0; index < size; index++) {
                        ...
                        int bottomRadius = (index == size - 1) && !roleHasMore ? QChatConstant.CORNER_RADIUS_ARROW : 0;
                        QChatChannelRoleBean bean = new QChatChannelRoleBean(roleInfo, topRadius, bottomRadius);
            ...
            public void onFailed(int code) {
                ...
                roleFetchResult.setError(code, ErrorUtils.getErrorText(code,R.string.qchat_channel_fetch_role_error));
                roleLiveData.postValue(roleFetchResult);
            }
            ...
            public void onException(@Nullable Throwable exception) {
                ...
                roleFetchResult.setError(QChatConstant.ERROR_CODE_CHANNEL_ROLE_FETCH, R.string.qchat_channel_fetch_role_error);
                roleLiveData.postValue(roleFetchResult);
            }
        });
    }
    ...
    public void deleteRole(QChatChannelRoleBean bean, int position) {
        QChatRoleRepo.deleteChannelRole(serverId, channelId, bean.channelRole.getRoleId(), new FetchCallback<Void>() {
            @Override
            ...
            public void onFailed(int code) {
                ...
                roleFetchResult.setError(code, ErrorUtils.getErrorText(code, R.string.qchat_channel_role_delete_error));
                roleLiveData.postValue(roleFetchResult);
            }
            ...
            public void onException(@Nullable Throwable exception) {
                ...
                roleFetchResult.setError(QChatConstant.ERROR_CODE_CHANNEL_ROLE_DELETE, R.string.qchat_channel_role_delete_error);
                roleLiveData.postValue(roleFetchResult);
            }
        });
    }
    ...
    public void fetchMemberData(long serverId, long channelId, long offset) {
        QChatChannelRepo.fetchChannelRoleMembers(serverId, channelId, offset, memberPageSize, new FetchCallback<List<QChatChannelMember>>() {
            @Override
            public void onSuccess(@Nullable List<QChatChannelMember> param) {
                ...
                if (param != null && param.size() > 0) {
                    ...
                    if (param.size() < memberPageSize) {
                        ((QChatChannelMemberBean) addList.get(addList.size() - 1)).bottomRadius = QChatConstant.CORNER_RADIUS_ARROW;
                    }
            ...
            public void onFailed(int code) {
                ...
                memberFetchResult.setError(code, ErrorUtils.getErrorText(code, R.string.qchat_channel_fetch_member_error));
                memberLiveData.postValue(memberFetchResult);
            }
            ...
            public void onException(@Nullable Throwable exception) {
                ...
                memberFetchResult.setError(QChatConstant.ERROR_CODE_CHANNEL_MEMBER_FETCH, R.string.qchat_channel_fetch_member_error);
                memberLiveData.postValue(memberFetchResult);
            }
        });
    }
    ...
    public void deleteMember(QChatChannelMemberBean bean, int position) {
        ALog.d(TAG, "deleteMember", "info:" + serverId + "," + channelId + "," + bean.channelMember.getAccId());
        QChatRoleRepo.deleteChannelMemberRole(serverId, channelId, bean.channelMember.getAccId(), new FetchCallback<Void>() {
            @Override
            public void onSuccess(@Nullable Void param) {
            ...
            public void onFailed(int code) {
                ...
                memberFetchResult.setError(code, ErrorUtils.getErrorText(code, R.string.qchat_channel_member_delete_error));
                memberLiveData.postValue(memberFetchResult);
            }
            ...
            public void onException(@Nullable Throwable exception) {
                ...
                memberFetchResult.setError(QChatConstant.ERROR_CODE_CHANNEL_ROLE_DELETE, R.string.qchat_channel_member_delete_error);
                memberLiveData.postValue(memberFetchResult);
            }
        });
    }
    ...
    public List<QChatBaseBean> getHeaderData(String[] titleArray, String[] routerArray) {
        ...
        for (int index = 0; index < titleArray.length; index++) {
            ...
            addRole.router = routerArray != null && routerArray.length > index ? routerArray[index] : null;
            data.add(addRole);
