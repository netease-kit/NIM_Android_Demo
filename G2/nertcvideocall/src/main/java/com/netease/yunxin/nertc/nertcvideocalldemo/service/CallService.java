package com.netease.yunxin.nertc.nertcvideocalldemo.service;
        ...
        if (customInfo != null && uiService != null) {
            if (customInfo.callType == Utils.ONE_TO_ONE_CALL) {
                ...
                if (invitedEvent.getChannelBaseInfo().getType() == ChannelType.VIDEO) {
                    intent.setClassName(CallService.this, uiService.getOneToOneVideoChat());
                } else if (invitedEvent.getChannelBaseInfo().getType() == ChannelType.AUDIO) {
                    intent.setClassName(CallService.this, uiService.getOneToOneAudioChat());
                } else {
                    return null;
                }
                ...
                intentTeam.setClassName(CallService.this, uiService.getGroupVideoChat());
