...
import com.netease.yunxin.app.im.utils.ConvertUtils;
...
public class WelcomeActivity extends AppCompatActivity {
    ...
    private void startLogin() {
        AuthorConfig authorConfig = new AuthorConfig(DataUtils.readAppKey(this), LOGIN_PARENT_SCOPE, LOGIN_SCOPE, false);
     ...
     *
     */
    private void loginIM(UserInfo userInfo, FinishAction finishAction) {

        LoginService.loginIMWithQChat(ConvertUtils.convertTo(userInfo), DataUtils.readAppKey(this),new LoginCallback<QChatLoginResult>() {
            @Override
