...
public abstract class CropImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private int mFocusWidth = 360;         //焦点框的宽度
    private int mFocusHeight = 360;        //焦点框的高度
    ...
    private void initImage() {
        ...
        float midPointX = viewWidth / 2f;
        float midPointY = viewHeight / 2f;
...
//                    bitmap.recycle();
     ...
     * @param isSaveRectangle 是否希望按矩形区域保存图片
     */
    public boolean saveBitmapToFile(File folder, int expectWidth, int exceptHeight, boolean isSaveRectangle) {
