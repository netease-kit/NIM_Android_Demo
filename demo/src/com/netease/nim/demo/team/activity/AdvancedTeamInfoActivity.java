...
import com.netease.nim.demo.team.helper.TeamHelper;
...
public class AdvancedTeamInfoActivity extends TActionBarActivity implements
    ...
    private View layoutSearchMessage;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case ContactSelectActivity.REQUEST_CODE:
    ...
    private void findViews() {
        ...
        layoutSearchMessage = findViewById(R.id.team_search_message_layout);
        ((TextView) layoutSearchMessage.findViewById(R.id.item_title)).setText(R.string.message_search_title);
        layoutSearchMessage.findViewById(R.id.item_detail).setVisibility(View.GONE);
        layoutSearchMessage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SearchMessageActivity.start(AdvancedTeamInfoActivity.this, teamId, SessionTypeEnum.Team);
                finish();
            }
        });
    ...
    private void updateTeamInfo(final Team t) {
        ...
        teamHeadImage.setImageResource(R.drawable.avatar_group);
    ...
    private void onTransferTeam() {
        ...
        ContactSelectActivity.startActivityForResult(this, option, REQUEST_CODE_TRANSFER);
        dialog.dismiss();
    }
    ...
    private void setBusinessCard(final String nickname) {
        DialogMaker.showProgressDialog(this, getString(R.string.empty), true);
        NIMClient.getService(TeamService.class).updateMemberNick(teamId, DemoCache.getAccount(), nickname).setCallback(new RequestCallback<Void>() {
            @Override
            public void onSuccess(Void param) {
                DialogMaker.dismissProgressDialog();
