package com.netease.nim.demo.common.ui.liv;
...
import com.netease.nim.demo.common.ui.liv.LetterIndexView.OnTouchingLetterChangedListener;
...
public class LivIndex {
	...
	private final PullToRefreshListView lvContacts;
	...
	public LivIndex(PullToRefreshListView contactsListView, LetterIndexView letterIndexView, TextView letterHit, ImageView imgBackLetter,
	...
	private class LetterChangedListener implements OnTouchingLetterChangedListener {
		...
		public void onHit(String letter) {
            ...
            index += lvContacts.getRefreshableView().getHeaderViewsCount();
            if (index >= 0 && index < lvContacts.getRefreshableView().getCount()) {
                lvContacts.getRefreshableView().setSelectionFromTop(index, 0);
            }
