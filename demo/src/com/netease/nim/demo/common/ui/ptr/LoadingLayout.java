...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
		...
		disableHeaderViewHardWareAccess();
		...
		if (attrs.hasValue(R.styleable.PullToRefresh_ptrHeaderSubTextAppearance)) {
			TypedValue styleID = new TypedValue();
			attrs.getValue(R.styleable.PullToRefresh_ptrHeaderSubTextAppearance, styleID);
	...
	@TargetApi(11)
	public   void disableHeaderViewHardWareAccess(){
