package com.netease.nim.demo.common.ui.dialog;
...
public class MenuDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rootView = (ViewGroup) View.inflate(context, R.layout.menu_dialog, null);
        ...
        for (int i = 0; i < btnNames.size(); i++) {
            itemView = View.inflate(context, R.layout.menu_dialog_item, null);
