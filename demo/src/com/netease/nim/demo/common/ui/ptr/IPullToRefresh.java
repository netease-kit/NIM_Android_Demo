...
public interface IPullToRefresh<T extends View> {
	...
	/**
	 * Reset current mode to default value for setRefreshing.
	 * This is only really useful when using <code>Mode.BOTH</code>
	 */
	...
	/**
	 * Set OnListViewEventListener for the Widget
	 * 
